...
$(document).ready(function(){
    ...
    var Simplachat = new SimplaChat(options);
    
});

SimplaChat = function(options){
    this.currentStatus = "";
    this.userListRef = new Firebase(options.url+options.hash+"/userlist");
    this.myUserRef = this.userListRef.push();
    this.connectedRef = new Firebase("https://purcellchat.firebaseIO.com/.info/connected");
...
SimplaChat.prototype.initUsers = function(){
    ...
    this.connectedRef.on("value", function(isOnline) {
      if (isOnline.val()) {
        ...
        setUserStatus(this.currentStatus);
      }
    });
    ...
    function setUserStatus(status) {
      ...
      this.myUserRef.set({ name: name, status: status });
    }
